...
## What is this?
This is the smallest and cheapest adapter you can get, that has 3 USB-A "input" and 1 USB-A "output" ports. It is using a RP2040 microcontroller to run either GP2040-CE or HID Remapper firmware.
